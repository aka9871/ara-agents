# ARA Agents for Opencode

> Status: **In development** — contributions welcome

This directory will contain ARA agents adapted for [Opencode](https://opencode.ai).

## Planned agents

| Agent | What it will do |
|-------|----------------|
| `ara-auditor` | Score any site A–F from inside Opencode |
...
Opencode agents should expose the same commands via Opencode's agent/tool interface.
